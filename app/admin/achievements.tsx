...
export default function AdminAchievementsScreen() {
  ...
  const handleLoadDefaults = () => {
    Alert.alert("Load All 52 Achievements", "This will add all 52 achievements from the official list (Combat, Survival, Chaos). Existing ones will remain.", [
    ...
    <ScreenContainer edges={["top", "left", "right", "bottom"]}>
      <ScrollView contentContainerStyle={{ padding: 16, paddingBottom: 40 }} showsVerticalScrollIndicator={false}>
        ...
        <View className="flex-row gap-3 mb-4">
          ...
          >
            <Text className="text-primary font-bold text-sm">📦 Load All 52</Text>
          </TouchableOpacity>
          <TouchableOpacity
